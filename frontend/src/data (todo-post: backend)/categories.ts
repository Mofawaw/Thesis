...
const categories: ThCategory[] = [
  {
    ...
    baseTippNodes: [
      { id: "ti-1", type: "text", data: { title: "Tipp 1", size: "small" } },
      { id: "ti-sol", type: "codeIDE", data: { title: "Lösung", size: "large", codeIDE: { main: false, scopeId: "t-ide-2", config: { type: "program+graph", mode: "read", runnable: true } } } },
    ],
    expected: "output"
  },
  {
    ...
    baseTippNodes: [
      { id: "ti-1", type: "codeIDE", data: { title: "Tipp 2", size: "small", codeIDE: { main: false, scopeId: "c-ide-2", config: { type: "graph", mode: "read", runnable: false } } } },
      { id: "ti-sol", type: "codeIDE", data: { title: "Lösung", size: "medium", codeIDE: { main: false, scopeId: "t-ide-2", config: { type: "program", mode: "read", runnable: true } } } },
    ],
    expected: "graph"
  },
  {
    ...
    baseTippNodes: [
      { id: "ti-1", type: "codeIDE", data: { title: "Tipp 1", size: "small", codeIDE: { main: false, scopeId: "t-ide-1", config: { type: "program", mode: "write", runnable: true } } } },
      { id: "ti-2", type: "codeIDE", data: { title: "Tipp 2", size: "small", codeIDE: { main: false, scopeId: "c-ide-2", config: { type: "graph", mode: "read", runnable: true } } } },
      { id: "ti-sol", type: "codeIDE", data: { title: "Lösung", size: "medium", codeIDE: { main: false, scopeId: "t-ide-2", config: { type: "graph", mode: "read", runnable: false } } } },
    ],
    expected: "graph"
  }
]
