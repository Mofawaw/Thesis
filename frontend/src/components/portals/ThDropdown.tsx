...
const ThDropdownPortal: React.FC<ThDropdownPortalProps> = ({ width, height, thColor, children, buttonRef, onClose }) => {
...
const ThDropdown: React.FC<ThDropdownProps> = ({ width, height, thColor, button, children, isOpen, onClose }) => {
