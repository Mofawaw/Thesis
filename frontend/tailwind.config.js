  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        ...
        'th-gradient-20': "linear-gradient(to bottom right, #D1F0F5, #EBEBEB, #D1F0F5, #D1D7F5, #F5D1E9, #EBEBEB, #F5D1E9)",
        'th-gradient-10': "linear-gradient(to bottom right, #E8F8FA, #EBEBEB, #E8F8FA, #E8EBFA, #FAE8F4, #EBEBEB, #FAE8F4)",
      ...
      animation: {
        ...
        'th-gradient-slow': 'background 12s ease infinite',
